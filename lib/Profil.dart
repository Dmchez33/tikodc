  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Idrissa Dembele', style: TextStyle(color: Colors.black)),
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: const DecorationImage(image: AssetImage('assets/images/idi.jpg'), fit: BoxFit.cover),
