                  ...
                  child: ElevatedButton(
                    onPressed: () => {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => InscriptionEtape()))
                    },
                    style: ElevatedButton.styleFrom(
                      elevation: 0.0,
                      backgroundColor: Colors.white,
                          ...
                          child: Row(
                            ...
                            children: const [
                              Padding(
                                  ...
                                  child: Text('Tu as dejà un compte?',
          ...
          child: Center(
            child: Column(
              children: <Widget>[
                ...
                const Text(
                  'Gérer ton compte, consulte les notification, commente tes vidéos et bien plus encore',
                  style: TextStyle(
                    fontSize: 16.0,
                    color: Colors.black54,
                  ),
                ...
                Container(
                    ...
                    child: Align(
                      ...
                      child: MaterialButton(
                          ...
                          onPressed: () {
                            // _openPopup(context);
                            // Navigator.push(context, MaterialPageRoute(builder: (context) => _openPopup(context) ));
                          },
                          child: Row(
